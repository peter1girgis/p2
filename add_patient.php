...
<body class="bg-gray-900 min-h-screen py-12 px-4 flex flex-col items-center justify-center font-[&#39;Tajawal&#39;]">
    <div  class="w-full max-w-6xl p-8 space-y-6 bg-gray-800 rounded-lg shadow-xl">
        <div class="text-center">
            ...
            <form method="post" action="store.php" class="space-y-6 max-w-2xl mx-auto">
                <div class="flex flex-col gap-2 text-right">
                    <label class="text-white">name</label>
                    <input name="name" type="text" class="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-custom" placeholder="أدخل اسم المريض"/>
                </div>
                <div class="flex flex-col gap-2 text-right">
                    <label class="text-white">phone</label>
                    <input name="phone" type="tel" class="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-custom" placeholder="أدخل رقم الهاتف"/>
                </div>
                <div class="flex flex-col gap-2 text-right" id="diagnosis-container">
                    <label class="text-white">the diagnosis</label>
                    <textarea name="diagnosis" class="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-custom h-32" placeholder="enter the diagnosis " id="diagnosis-input"></textarea>
                </div>
