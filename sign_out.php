...
<body class="bg-gray-900 min-h-screen flex flex-col items-center justify-center font-[&#39;Tajawal&#39;]">
    <div class="w-full max-w-md p-8 space-y-8 bg-gray-800 rounded-lg shadow-xl">
        <div class="text-center">
            ...
            <h2 class="mt-6 text-3xl font-bold text-white">إنشاء حساب جديد</h2>
            <p class="mt-2 text-sm text-gray-400">قم بإنشاء حساب للمتابعة</p>
        </div>
        <form method="post" action="add_doctor.php" class="mt-8 space-y-6">
            <div class="space-y-6">
                <div class="relative">
                    <label for="phone" class="block text-sm font-medium text-gray-300 mb-2">رقم الهاتف</label>
                    <div class="relative">
                        <input id="phone" name="phone" type="tel" required="" class="appearance-none block w-full pr-10 py-3 bg-gray-700 border border-gray-600 !rounded-button placeholder-gray-400 text-white focus:outline-none focus:ring-2 focus:ring-custom focus:border-custom" placeholder="أدخل رقم هاتفك"/>
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        <input id="name" name="name" type="text" required="" class="appearance-none block w-full pr-10 py-3 bg-gray-700 border border-gray-600 !rounded-button placeholder-gray-400 text-white focus:outline-none focus:ring-2 focus:ring-custom focus:border-custom" placeholder="أدخل اسمك"/>
                        <div class="absolute inset-y-0 right-0 flex items-center pr-3">
            ...
            <button type="submit" class="w-full flex justify-center py-3 px-4 border border-transparent !rounded-button text-sm font-medium text-white bg-custom hover:bg-custom-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-custom">إنشاء حساب</button>
        </form>
        <div class="text-center">
            <p class="text-sm text-gray-400">لديك حساب بالفعل؟ <a href="login.php" class="font-medium text-custom hover:text-custom-600">تسجيل الدخول</a></p>
        </div>
    </div>
    </body>
</html>
